package com.jh.calendarapitest;
...
public class CalendarApiActivity extends Activity implements EasyPermissions.PermissionCallbacks {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendari_api);


        mAddCalendarButton = (Button) findViewById(R.id.button_main_add_calendar);
        //mAddCalendarButton = (Button) findViewById(R.id.nav_share);
        mAddEventButton = (Button) findViewById(R.id.nav_send);
        mGetEventButton = (Button) findViewById(R.id.nav_get);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private CalendarApiActivity mActivity;
        List<String> eventStrings = new ArrayList<String>();


        public MakeRequestTask(CalendarApiActivity activity, GoogleAccountCredential credential) {
